...
- **Sửa lỗi & Tính năng mới:**
  ...
  2. **Ẩn trường nhập Giờ Y lệnh thủ công:** Ẩn ô nhập giờ y lệnh trên form bệnh nhân để tinh giản giao diện. Hệ thống tự động thiết lập giờ vào `07:30` cho bệnh nhân cũ. Đối với bệnh nhân mới, hệ thống tự lấy giờ hiện tại của hệ thống để phân loại buổi điều trị Sáng (trước 12h) hoặc Chiều (từ 12h trở đi) một cách thông minh.
