...
async function ensureSchema(db) {
  ...
  try {
    const stmts = [
      ...
      db.prepare("CREATE TABLE IF NOT EXISTS thu_thuat (id INTEGER PRIMARY KEY AUTOINCREMENT, ten_thu_thuat TEXT UNIQUE NOT NULL, viet_tat TEXT DEFAULT '', he TEXT DEFAULT 'PHCN', phan_loai TEXT DEFAULT '', may TEXT DEFAULT '', tg_thuc_hien INTEGER DEFAULT 30, tg_thuc_hien_max INTEGER DEFAULT 0, tg_thu_thuat INTEGER DEFAULT 30, tg_thu_thuat_max INTEGER DEFAULT 0, khoang_cach INTEGER DEFAULT 0, can_rut_may INTEGER DEFAULT 0, can_nguoi_phu INTEGER DEFAULT 0, ds_nguoi_phu TEXT DEFAULT '', lien_tuc INTEGER DEFAULT 0, order_idx INTEGER DEFAULT 0, is_active INTEGER DEFAULT 1, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP)"),
