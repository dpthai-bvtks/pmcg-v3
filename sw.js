/**
 * SERVICE WORKER CHO PHẦN MỀM XẾP LỊCH YHCT - PHCN (T.I.M.E.S System v3.1.8)
 * Quản lý Cache đệm tĩnh, cho phép mở App ngoại tuyến (Offline-first) và tải tức thì.
 */

const CACHE_NAME = 'pmcg-cache-v3.1.8';
const STATIC_ASSETS = [
  './',
  './index.html',
  './hdsd.html',
...
self.addEventListener('install', (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      console.log('[Service Worker] Đang nạp bộ nhớ đệm tĩnh v3.1.8...');
